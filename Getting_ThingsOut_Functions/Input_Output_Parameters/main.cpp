...
void max_str(const std::string& input1, const std::string input2,
			std::string& output) // This is a true reference
{
	if(input1 > input2){
		output = input1;
	}else{
...
int main(){
   ...
   double in_double2{86.9};
   max_double(in_double1,in_double2,&out_double); // because out_double is a pointer in needs to be passed as an address &
